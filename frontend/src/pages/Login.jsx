                    ...
                    <form onSubmit={handleSubmit}>
                        <div className='flex flex-col gap-5'>
                            ...
                            <button
                                type='submit'
                                disabled={loading}
                                className='cursor-pointer bg-primary text-white rounded-md text-2xl py-3 mt-4 flex items-center justify-center disabled:opacity-60'
                            >
                                {loading ? (
                                    <div className='w-6 h-6 border-4 border-white border-t-transparent rounded-full animate-spin flex items-center justify-center'></div>
                                ) : (
                                    'Entrar'
                                )}
                            </button>
                            ...
                            {error && (
                                <div className='bg-red-100 border border-red-400 text-red-700 rounded flex justify-center'>
                                    {error.includes('401')
