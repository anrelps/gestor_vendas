...
const Login = () => {
  ...
  return (
    <div className='fixed inset-0 flex items-center justify-center bg-linear-to-br from-gray-100 to-gray-200 p-4 overflow-hidden'>
            <div className='border border-gray-200 rounded-xl max-w-md w-full mx-auto shadow-xl overflow-hidden bg-white transition-shadow duration-300 hover:shadow-2xl'>
